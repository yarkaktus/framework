...
class ProductTest extends TestCase
{
    ...
    public function dataProviderProduct(): \Generator
    {
        ...
        yield 'product list' => [
            [
                new ProductEntity(3, 'Another', 50.11, 'описание курса'),
            ]
        ];
    }
    ...
    public function dataProviderAllProduct(): \Generator
    {
        ...
        yield 'product list' => [
            [
                new ProductEntity(3, 'Another', 50.11, 'описание курса'),
                new ProductEntity(10, 'Test', 199.99, 'описание курса'),
            ]
        ];

        yield 'product list with extreme values' => [
            [
                new ProductEntity(0, '', 0, 'описание курса'),
                new ProductEntity(PHP_INT_MAX, 'Test', 1.7976931348623e+308, 'описание курса'),
            ]
        ];
    }
}
